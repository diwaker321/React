...
// for grouping your test you can use the describe function

describe("these test should contains the test of contact component" , ()=>{
...
//to check only one use getByRole
// you can use either it or you can use test
it("this will check if the button is load or not",()=>{
    render(<Contact/>)
    const button = screen.getByRole("button")
    expect(button).toBeInTheDocument()
})
